...
hyprctl keyword general:col.active_border $active_border_hex # $active_border 45deg
hyprctl keyword general:col.inactive_border $inactive_border_hex # $inactive_border 45deg
